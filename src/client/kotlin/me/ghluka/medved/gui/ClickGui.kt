...
class ClickGui : Screen(Component.literal("Medved")) {
    ...
    internal fun drawConfigBar(g: GuiGraphicsExtractor, mx: Int, my: Int) {
    ...
    internal fun drawCategoryPanel(g: GuiGraphicsExtractor, cat: Module.Category, mx: Int, my: Int) {
